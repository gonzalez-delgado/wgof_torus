...
#'
#' @param x A vector of two coordinates in the two-dimensional flat torus, parametrized as the periodic [0,1) x [0,1).
#' @param y A vector of two coordinates in the two-dimensional flat torus, parametrized as the periodic [0,1) x [0,1).
#' 
